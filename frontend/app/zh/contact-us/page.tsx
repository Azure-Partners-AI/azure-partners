...
export const metadata = {
  ...
  description:
    "Get in touch with Azure Partners. Email us or scan our WeChat QR code.",
};
    ...
    <main className="min-h-screen bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 py-24">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-12">联系我们</h1>

          <div className="mb-12">
            <h2 className="text-2xl font-semibold mb-4">电子邮件</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4">微信</h2>
